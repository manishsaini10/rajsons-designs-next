      ...
      <section className="relative bg-gradient-to-br from-[#0f1f36] via-[#1a3355] to-[#0f1f36] py-16 md:py-24 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6">
          <motion.div initial="hidden" animate="visible">
            <motion.h1 variants={fadeUp} custom={0} className="text-3xl sm:text-4xl font-bold text-white md:text-5xl lg:text-6xl">Packages Details</motion.h1>
            <motion.p variants={fadeUp} custom={1} className="mt-3 text-sm text-gray-400">
              ...
              <span className="text-gray-300">Packages Details</span>
            </motion.p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid gap-12 lg:grid-cols-3">
            <div className="lg:col-span-2">
              ...
              >
                Our web design packages are cost effective and suits all types of business needs. All packages include award-winning content management system (CMS), to enable you with the facilities of edit and delete the pages from the browser you used and from the based control panel for the comfort of your home.
              </motion.p>
