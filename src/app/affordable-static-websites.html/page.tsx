      ...
      <section className="relative bg-gradient-to-br from-[#0f1f36] via-[#1a3355] to-[#0f1f36] py-16 md:py-24 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6">
          <motion.div initial="hidden" animate="visible">
            <motion.h1 variants={fadeUp} custom={0} className="text-3xl sm:text-4xl font-bold text-white md:text-5xl lg:text-6xl">Affordable Static Websites</motion.h1>
            <motion.p variants={fadeUp} custom={1} className="mt-3 text-sm text-gray-400">
              ...
              <span className="text-gray-300">Static Websites</span>
            </motion.p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="lg:col-span-2">
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-80px" }}>
                <motion.div variants={fadeUp} custom={0} className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-[#1e3a5f]">Static Website Packages</h2>
                </motion.div>
                <motion.p variants={fadeUp} custom={1} className="text-lg text-gray-700 leading-relaxed">{staticWebsiteContent.intro}</motion.p>
                {staticWebsiteContent.paragraphs.map((p, i) => (
                  <motion.p key={i} variants={fadeUp} custom={i + 2} className="mt-5 text-base leading-relaxed text-gray-600">{p}</motion.p>
                ))}
              </motion.div>
