...
export const metadata: Metadata = {
  ...
  keywords: ["web design packages", "website packages", "dynamic web design", "ecommerce development packages", "affordable website packages"],
};
      ...
      <div className="bg-gradient-to-r from-[#1e3a5f] to-[#2a4a70] py-8 md:py-12">
        <div className="mx-auto max-w-7xl px-4">
          ...
          <p className="mt-2 text-sm text-gray-300">
            <Link href="/" className="text-[#f7941e] hover:underline">Home</Link> &rarr; Packages
          </p>
        </div>
      </div>
